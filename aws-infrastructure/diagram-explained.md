...
ML and DL now can actually cross reference different sources of data for complex models to be able to run more efficienclty, also here we implement PyWren models to create spot and other forecast options
