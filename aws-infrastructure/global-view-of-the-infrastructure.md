...
**Availability Zones (AZs)**.  Well for all Dev/Test/Staging just pick the lowest AZ (ie. 2a or 1a).  For Production and Management, @elpresi and @jamesdaley can assist with this setup (its app specific).
