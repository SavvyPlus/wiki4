...
The retailers will be provided with the standard rate card template during the tender request for them to respond with their offers. Upon receiving the retailer's response and rather than entering the offers manually to the Service Agreement template, this template will be able to automatically transform the data and fill up the Service Agreement template
